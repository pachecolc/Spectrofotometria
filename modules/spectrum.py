...
EXPERIMENTAL_WAVELENGTHS_NM = np.arange(440, 801, 15, dtype=float)
...
def generate_spectrum(
    ...
    """Generate a Gaussian educational spectrum at the guide wavelengths."""
    if amplitude < 0:
    ...
    wavelengths = EXPERIMENTAL_WAVELENGTHS_NM.copy() if wavelengths_nm is None else np.asarray(wavelengths_nm, dtype=float)
